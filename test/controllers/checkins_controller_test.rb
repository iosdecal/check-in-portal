...
class CheckinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post checkins_url, params: { checkin: { buddy_id: @checkin.buddy_id, integer: @checkin.integer, integer: @checkin.integer, user_id: @checkin.user_id, week: @checkin.week } }
    end
  ...
  test "should update checkin" do
    patch checkin_url(@checkin), params: { checkin: { buddy_id: @checkin.buddy_id, integer: @checkin.integer, integer: @checkin.integer, user_id: @checkin.user_id, week: @checkin.week } }
